(function() {
  ...
  angular.module('starter').directive('verticalAlign', ['$timeout', verticalAlign]);
  ...
  angular.module('starter').directive('repeatHref', ['$location', repeatHref]);
  ...
  //
  //angular.module('starter').directive('parseFbHtml', ['$timeout', '$compile', '$rootScope', parseFbHtml]);
  //
  ...
  //
  //
  //angular.module('starter').directive('parseHtmlRe', ['$timeout', '$compile', '$rootScope', parseHtmlRe]);
  //
  ...
  //
  //angular.module('starter').directive('parseHtml', ['$timeout', '$compile', '$rootScope', parseHtml]);
  //
  ...
  //
  //angular.module('starter').directive('parseHtmlLinks',
  //  ['$rootScope', '$cordovaInAppBrowser', '$ionicLoading', '$ionicModal', '$window', '$document',
  ...
  //}
  //
  //angular.module('starter').directive('parseHtmlLinks2', ['$rootScope', '$cordovaInAppBrowser', '$ionicLoading', '$ionicModal', '$window', '$document',
  ...
  angular.module('starter').directive('replaceText', ['$timeout', replaceText]);
  ...
  angular.module('starter').directive('passwordMatch', [passwordMatch]);
  ...
  angular.module('starter').directive('visibleView', [visibleView]);
  ...
  angular.module('starter').directive('openbrowser', function($ionicGesture) {
    return {
      restrict: 'A',
  ...
  //
  //angular.module('starter').directive('parseHtmlLinksNdc', ['$rootScope', '$cordovaInAppBrowser', '$ionicLoading', '$ionicModal', '$window', '$document',
  ...
  //angular.module('starter').directive('parseHtmlLinksAdc', ['$rootScope', '$cordovaInAppBrowser', '$ionicLoading', '$ionicModal', '$window', '$document',
